...
internal final class Device: MetalDevice {
    ...
    internal lazy var paramValues: [cl_device_info: Any] = [
        ...
        cl_device_info(CL_DEVICE_NATIVE_VECTOR_WIDTH_FLOAT): UInt32(4),
        cl_device_info(CL_DEVICE_NATIVE_VECTOR_WIDTH_HALF): UInt32(4),
        cl_device_info(CL_DEVICE_NATIVE_VECTOR_WIDTH_INT): UInt32(4),
        cl_device_info(CL_DEVICE_NATIVE_VECTOR_WIDTH_LONG): UInt32(4),
        cl_device_info(CL_DEVICE_NATIVE_VECTOR_WIDTH_SHORT): UInt32(4),
        ...
        cl_device_info(CL_DEVICE_PREFERRED_VECTOR_WIDTH_FLOAT): UInt32(4),
        cl_device_info(CL_DEVICE_PREFERRED_VECTOR_WIDTH_HALF): UInt32(4),
        cl_device_info(CL_DEVICE_PREFERRED_VECTOR_WIDTH_INT): UInt32(4),
        cl_device_info(CL_DEVICE_PREFERRED_VECTOR_WIDTH_LONG): UInt32(4),
        cl_device_info(CL_DEVICE_PREFERRED_VECTOR_WIDTH_SHORT): UInt32(4),
