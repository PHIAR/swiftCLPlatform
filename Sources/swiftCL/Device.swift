...
public final class Device: MetalDevice {
    ...
    private static let paramValueSizes: [cl_device_info: Int] = [
        ...
        cl_device_info(CL_DEVICE_IMAGE2D_MAX_HEIGHT): MemoryLayout <size_t>.size,
        cl_device_info(CL_DEVICE_IMAGE2D_MAX_WIDTH): MemoryLayout <size_t>.size,
        cl_device_info(CL_DEVICE_IMAGE3D_MAX_DEPTH): MemoryLayout <size_t>.size,
        cl_device_info(CL_DEVICE_IMAGE3D_MAX_HEIGHT): MemoryLayout <size_t>.size,
        cl_device_info(CL_DEVICE_IMAGE3D_MAX_WIDTH): MemoryLayout <size_t>.size,
        cl_device_info(CL_DEVICE_LOCAL_MEM_SIZE): MemoryLayout <UInt64>.size,
        cl_device_info(CL_DEVICE_LOCAL_MEM_TYPE): MemoryLayout <cl_device_local_mem_type>.size,
        ...
        cl_device_info(CL_DEVICE_MAX_PARAMETER_SIZE): MemoryLayout <size_t>.size,
        ...
        cl_device_info(CL_DEVICE_MAX_WORK_GROUP_SIZE): MemoryLayout <size_t>.size,
    ...
    internal lazy var paramValues: [cl_device_info: Any] = [
        ...
        cl_device_info(CL_DEVICE_IMAGE2D_MAX_HEIGHT): 2048,
        cl_device_info(CL_DEVICE_IMAGE2D_MAX_WIDTH): 2048,
        cl_device_info(CL_DEVICE_IMAGE3D_MAX_DEPTH): 512,
        cl_device_info(CL_DEVICE_IMAGE3D_MAX_HEIGHT): 512,
        cl_device_info(CL_DEVICE_IMAGE3D_MAX_WIDTH): 512,
        cl_device_info(CL_DEVICE_LOCAL_MEM_SIZE): self.device.maxThreadgroupMemoryLength,
        cl_device_info(CL_DEVICE_LOCAL_MEM_TYPE): cl_device_local_mem_type(CL_LOCAL),
